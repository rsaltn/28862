...
This repo contains the code used by Red Lotus for the FTC DECODE 2025-2026 season.

## Welcome!
This GitHub repository contains the source code + logic code in TeamCode directory that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK + Red Lotus team code, download/clone the entire project to your local computer.
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://github.com/rsaltn/28862.git</p>
