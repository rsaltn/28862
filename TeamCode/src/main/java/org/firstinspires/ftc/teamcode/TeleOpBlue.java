...
public class TeleOpBlue extends OpMode {
    ...
    // Пресеты (RPM / угол)
    public static double PRESET_NEAR_RPM   = 3000;
    public static double PRESET_NEAR_ANGLE = 0;
    public static double PRESET_MID_RPM    = 3900;
    public static double PRESET_MID_ANGLE  = 90;
    ...
    public void init() {
        ...
        Camera.aprilTagPipelineIndex = num_tag;
