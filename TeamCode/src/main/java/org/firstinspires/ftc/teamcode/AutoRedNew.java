...
@Configurable
@Autonomous(name = "Auto Red new ", group = "Digital")
...
// private PathChain startToShoot, returnToStart1, returnToStart2, returnToStart3,returnToStart4,returnToStart5, art1Continuous, art2Continuous, art3Continuous, art4Continuous, art5Continuous,gate1;
    ...
    private Pose startPose =new Pose(144-29.000, 133.000,Math.toRadians(180-143));
    private final Pose End = new Pose(144-30, 58, Math.toRadians(90));
...
//        servo.setPower(angle);
    ...
    private void buildPaths() {
        ...
        gate = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(144-22.000, 66.2),

                                new Pose(144-16.500, 66.200)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
        ...
        gateToCollect = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(144-16.000, 66.200),
                                new Pose(144-19.000, 57.000),
                                new Pose(144-11.000, 54.000)
                        )
