...
@Disabled
@Autonomous(name = "AutoT", group = "Digital")
public class AutoTelegram extends OpMode {
    ...
    /* ================= CONFIG ================= */
    public static double SHOOTER_VELOCITY = 850;
    public static int TOTAL_SHOTS = 3;

    public static double READY_VELOCITY = 830;
    public static double DROP_VELOCITY  = 800;
    ...
    private  double breakingPoint = 0.14;
    public static double MAX_SHOOT_TIME = 4.5; // секунд на одну серию
...
//                intakeOff();
            ...
            case SHOOT_3:
                if (updateShootFSM()) {
                    shooterOff();
                    pathState = PathState.GO_ART3_START;
                    pathTimer.resetTimer();
                    delay=true;
                }
                break;
