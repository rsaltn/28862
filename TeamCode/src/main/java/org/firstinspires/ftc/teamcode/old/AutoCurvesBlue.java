...
@Disabled
@Autonomous(name = "AutoCB", group = "Digital")
public class AutoCurvesBlue extends OpMode {
    ...
    /* ================= CONFIG ================= */
    public static double SHOOTER_VELOCITY = 760;
    public static int TOTAL_SHOTS = 3;

    public static double READY_VELOCITY = 745;
    public static double DROP_VELOCITY  = 690;
    ...
    public static double MAX_SHOOT_TIME = 7; // секунд на одну серию
    ...
    private final Pose shootPose =
            new Pose(31,116.34624145785878,Math.toRadians(137));

    private final Pose artifactPoseStart1 =
            new Pose(60, 90, Math.toRadians(180));
    private final Pose artifactPoseEnd1 =
            new Pose(18, 85.5, Math.toRadians(180));

    private final Pose artifactPoseStart2 =
            new Pose(60, 63, Math.toRadians(180));
    private final Pose artifactPoseEnd2 =
            new Pose(10, 61.0, Math.toRadians(180));
    private final Pose artifactPoseStart3 =
            new Pose(70,45.42596810933941,Math.toRadians(180));
    private final Pose artifactPoseEnd3 =
            new Pose(10,42.0,Math.toRadians(180));
...
//                .build();
        ...
        returnToStart2 = follower.pathBuilder()
                .addPath(new BezierCurve(artifactPoseEnd2,new Pose(34.161731207289293,61.04328018223235,Math.toRadians(180)), shootPose))
...
//                .build();
        returnToStart3 = follower.pathBuilder()
                .addPath(new BezierCurve(artifactPoseEnd3,new Pose(31.161731207289293,65.04328018223235,Math.toRadians(180)), shootPose))
                .setLinearHeadingInterpolation(artifactPoseEnd3.getHeading(), shootPose.getHeading())
                .build();

        art1Continuous = follower.pathBuilder()

                .addPath(new BezierCurve(shootPose, new Pose(80,83.1526195899772,Math.toRadians(170)),artifactPoseEnd1))
        ...
        art2Continuous = follower.pathBuilder()
                ...
                .addPath(new BezierCurve(shootPose, new Pose(80,58.87927107061503,Math.toRadians(170)),artifactPoseEnd2))
                .setLinearHeadingInterpolation(shootPose.getHeading(),artifactPoseEnd2.getHeading())
                .setBrakingStrength(breakingPoint)
                .build();
        art3Continuous = follower.pathBuilder()

                .addPath(new BezierCurve(shootPose, new Pose(80,34.113895216400905,Math.toRadians(170)),artifactPoseEnd3))
                ...
                .addPath(new BezierLine(shootPose,new Pose(27, 70.0, Math.toRadians(90))))
                .setLinearHeadingInterpolation(follower.getHeading(),new Pose(10, 64.0, Math.toRadians(270)).getHeading())
                .setBrakingStrength(breakingPoint)
                .build();
    }
