...
@Disabled
@Autonomous(name = "FarRed", group = "Digital")
public class FarRed extends OpMode {
    ...
    public static double MAX_SHOOT_TIME = 25; // секунд на одну серию
    ...
    private final Pose startPose =
            new Pose(83, 12, Math.toRadians(90));
    private final Pose shootPose =
            new Pose(87, 15, Math.toRadians(angle));
