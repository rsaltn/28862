...
@Disabled
@Autonomous(name = "AutoCR", group = "Digital")
public class AutoCurvesRed extends OpMode {
    ...
    private final Pose startPose =
            new Pose(144-34.278, 135.144, Math.toRadians(0));
    private final Pose shootPose =
            new Pose(144-31,116.34624145785878,Math.toRadians(180-137));
...
//                .build();
        ...
        art3Continuous = follower.pathBuilder()
                ...
                .addPath(new BezierLine(shootPose,new Pose(144-27, 70.0, Math.toRadians(90))))
                .setLinearHeadingInterpolation(follower.getHeading(),new Pose(144-10, 64.0, Math.toRadians(270)).getHeading())
                .setBrakingStrength(breakingPoint)
                .build();
    }
